...
02
在弹出的”New Project" 窗口中选则文件夹，如图红色方框位置。

03
选择后的如图所示，这里的文件夹随意，但最好命名全为英文，且在非C盘。
...
07
现在，将鼠标放在创建的工程上，单击鼠标右键，然后依次选择“New>Python File".


08
然后会弹出一个”New Python File"的窗口，输入名字后单击“OK”。

09
然后，就可以输入代码了。

10
编写好以后，在编写代码的窗口中单击右键，然后选择“Run （你的文件名）”，就可以运行程序了。
